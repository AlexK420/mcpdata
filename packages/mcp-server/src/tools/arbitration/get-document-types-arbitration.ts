...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/arbitration/document-types-dictionary',
  operationId: '29_getArbitrationCasesDocTypesDictionary_1',
};

export const tool: Tool = {
  name: 'get_document_types_arbitration',
  description:
...
export const handler = async (client: Datanewton, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.arbitration.getDocumentTypes()));
};
