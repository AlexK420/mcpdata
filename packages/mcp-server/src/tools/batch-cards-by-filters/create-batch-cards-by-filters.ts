...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v1/batchCardsByFilters',
  operationId: '18_batchCounterpartiesByFilters',
};

export const tool: Tool = {
  name: 'create_batch_cards_by_filters',
  description: 'Получить данные контрагентов по фильтрам/условиям: оквэды, регионы и т.д.',
  inputSchema: {
    type: 'object',
    properties: {
      key: {
...
export const handler = async (client: Datanewton, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.batchCardsByFilters.create(body));
};
