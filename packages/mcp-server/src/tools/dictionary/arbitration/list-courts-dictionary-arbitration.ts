...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/dictionary/arbitration/courts',
  operationId: '28_getArbitrationCasesCourtsDictionary',
};

export const tool: Tool = {
  name: 'list_courts_dictionary_arbitration',
  description:
...
export const handler = async (client: Datanewton, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.dictionary.arbitration.listCourts()));
};
