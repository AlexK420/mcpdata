...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/dictionary/arbitration/dispute-categories',
  operationId: '30_getArbitrationCasesDisputesDictionary',
};

export const tool: Tool = {
  name: 'list_dispute_categories_dictionary_arbitration',
  description:
