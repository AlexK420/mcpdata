...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/dictionary/licenses',
  operationId: '23_getLicensesDictionary_1',
};

export const tool: Tool = {
  name: 'list_licenses_dictionary',
  description:
...
export const handler = async (client: Datanewton, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(await maybeFilter(jq_filter, await client.dictionary.listLicenses()));
  } catch (error) {
