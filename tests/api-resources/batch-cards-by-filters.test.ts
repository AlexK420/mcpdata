...
describe('resource batchCardsByFilters', () => {
  // Prism tests are disabled
  test.skip('create: only required params', async () => {
    const responsePromise = client.batchCardsByFilters.create({ key: 'key', limit: 0, offset: 0 });
  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.batchCardsByFilters.create({
      key: 'key',
      limit: 0,
      offset: 0,
